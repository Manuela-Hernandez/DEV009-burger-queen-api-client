    ...
    <>
      ...
      <section className='grid grid-cols-2 grid-rows-3 m-8'>
        <article className='grid grid-cols-2 grid-rows-2'>
          <input type="text" placeholder='Nombre del cliente' onChange={handleCustomerNameChange} className='h-12 col-span-2 m-2 rounded-md bg-gray-200 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-xl' />
