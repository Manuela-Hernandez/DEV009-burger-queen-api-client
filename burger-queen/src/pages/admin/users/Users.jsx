...
export default function AllUsers() {
    ...
    return (
        <section className="w-full h-full">
            ...
            <button className="text-bgqueen-primary rounded-lg text-xl m-2 border border-2 border-bgqueen-primary font-text-primary">Add user <i class="fa-solid fa-user-plus"></i></button>
            ...
            <tbody>
              {
                 usersList !== undefined && usersList.map((user) => (
                  <tr key={user.id} >
                    ...
                    <td><i class="fa-solid fa-user-pen"></i> <i class="fa-solid fa-user-xmark"></i></td>
                  </tr>
                ))
              }
            </tbody>
